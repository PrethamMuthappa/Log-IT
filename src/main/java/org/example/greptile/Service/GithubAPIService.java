 ...
 //   private String owner="PrethamMuthappa";
   // private String repo="user-activity";
    ...
    private CommitResponse parseCommitResponse(Map<String, Object> responseBody) {
        ...
        content.setText("Create a changelog for the following code patch and explain in short summary what the changes are and dont use the work you , make it like look like autogenerated " + changes.get(0).getPatch());
